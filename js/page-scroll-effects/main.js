jQuery(document).ready(function ($) {
    ...
    function goToSection(event, sectionNumber) {
        ...
        {
            middleScroll = (hijacking == 'off' && $(window).scrollTop() != visibleSection.offset().top) ? true : false;
            var animationParams = selectAnimation(animationType, middleScroll, 'next'); console.log("next " + actual + "<" + sectionNumber + "   " + animationParams);
            unbindScroll(visibleSection.next('.cd-section'), animationParams[3]);
            if (!animating) {
                animating = true;
                visibleSection.removeClass('visible').children('div').velocity(animationParams[1], animationParams[3], animationParams[4]);
                sectionsAvailable.eq(sectionNumber-1).addClass('visible').children('div').velocity(animationParams[0], animationParams[3], animationParams[4], function () {
                    //alert(sectionsAvailable.eq(sectionNumber - 1));
                    animating = false;
                });
        ...
        if (actual > sectionNumber)
        {
            ...
            var animationParams = selectAnimation(animationType, middleScroll, 'prev'); console.log("prev " + actual + ">" + sectionNumber + "   " + animationParams);
            unbindScroll(visibleSection.next('.cd-section'), animationParams[3]);
            if (!animating) {
                animating = true;
                visibleSection.removeClass('visible').children('div').velocity(animationParams[2], animationParams[3], animationParams[4]);
